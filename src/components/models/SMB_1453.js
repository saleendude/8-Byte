...
export default function SMB1453(props) {
  const group = useRef();
  const { nodes, materials } = useGLTF("/models/SMB_1453.glb");
  return (
    <group ref={group} {...props} dispose={null}>
      <group position={[0, 0.1, 0]} rotation={[Math.PI / 2, 0, 0]} scale={6}>
        <mesh
          castShadow
          receiveShadow
...
useGLTF.preload("/models/SMB_1453.glb");
